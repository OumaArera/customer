...
from customer_project.utils import APIResponse, validate_query_params
from orders.order_service import OrderService
from orders.serializers import OrderDeserializer, OrderSerializer, UpdateOrderDeserializer


class OrderView(APIView):
    """Handles the orders CRUD Operations"""
